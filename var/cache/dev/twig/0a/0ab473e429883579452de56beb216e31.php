...
/* post/show.html.twig */
class __TwigTemplate_a18740bc7a315030d11be8d334eded5b extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            // line 6
            echo "        <div class=\"form\" style=\"max-width: 20%\">
            ";
            // line 7
    ...
    Category: <em>";
        // line 11
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 11, $this->source); })()), "category", [], "any", false, false, false, 11), "html", null, true);
        echo "</em>
    <hr>
    <img src=\"";
        // line 13
        echo twig_escape_filter($this->env, ("/uploads/" . twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 13, $this->source); })()), "image", [], "any", false, false, false, 13)), "html", null, true);
...
";
    ...
    {
        return array (  92 => 13,  87 => 11,  84 => 10,  78 => 7,  75 => 6,  73 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    {% if is_granted('ROLE_ADMIN') %}
        <div class=\"form\" style=\"max-width: 20%\">
            {{ form(form) }}
        </div>
    {% endif %}
    <hr>
    ...
    <hr>
    <img src=\"{{ '/uploads/' ~ post.image }}\" alt=\"\" style=\"max-width: 50%\">
{% endblock %}", "post/show.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/sfcoursev2/templates/post/show.html.twig");
    }
}
